...
Repositorio de análisis y seguimiento de los mercados financieros globales, organizado en **4 categorías** correspondientes a las principales bolsas de valores del mundo. Cada bolsa es gestionada por un **sub-agente especializado** que realiza búsquedas exclusivamente en fuentes de confianza.
...
| # | Categoría | Carpeta | Sub-agente | Índices de referencia |
|---|-----------|---------|------------|----------------------|
...
├── .claude/agents/            ← definición de los 4 sub-agentes especializados
│   ├── bolsa-colombia.md
│   ├── bolsa-eeuu.md
│   ├── bolsa-asia.md
│   └── bolsa-europa.md
└── bolsas/
    ...
    └── europa/
        ...
        ├── historia-instrumentos/      ← histórico de 5 años por instrumento
